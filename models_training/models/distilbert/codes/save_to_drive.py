...
drive_results_path = '/content/drive/My Drive/article_classification/bert/results'
drive_logs_path = '/content/drive/My Drive/article_classification/bert/logs'
drive_times_path = '/content/drive/My Drive/article_classification/bert/times.txt'
...
print("Everything has been saved to Google Drive under article_classification/bert.")
