...
drive_results_path = '/content/drive/My Drive/article_classification/deberta/results'
drive_logs_path = '/content/drive/My Drive/article_classification/deberta/logs'
drive_times_path = '/content/drive/My Drive/article_classification/deberta/times.txt'
...
print("Everything has been saved to Google Drive under article_classification/deberta.")
