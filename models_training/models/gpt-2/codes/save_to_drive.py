...
drive_logs_path = '/content/drive/My Drive/article_classification/gpt2/logs'
drive_times_path = '/content/drive/My Drive/article_classification/gpt2/times.txt'
...
print("Everything has been saved to Google Drive under article_classification/gpt2.")
