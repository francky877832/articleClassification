...
drive_results_path = '/content/drive/My Drive/article_classification/roberta/results'
drive_logs_path = '/content/drive/My Drive/article_classification/roberta/logs'
drive_times_path = '/content/drive/My Drive/article_classification/roberta/times.txt'
...
print("Everything has been saved to Google Drive under article_classification/roberta.")
